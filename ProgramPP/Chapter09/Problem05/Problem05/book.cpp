...
Book::Book(string isbn, string ti, string auth, int cpyr, bool chk)  // constructor
	:isbn{ isbn }, ti{ ti }, auth{ auth }, cpyr {cpyr}, chkd{ chk } // initializers 
{
